...
VOID CVirtualButton::SetButtonImage(CD3DDevice * pD3DDevice, LPCTSTR pszResource, LPCTSTR pszTypeName, HINSTANCE hInstance)
{
	CD3DTexture *pD3DTextureButton = new CD3DTexture();
	pD3DTextureButton->LoadImage(pD3DDevice, hInstance, pszResource, pszTypeName);
	SetButtonImage(pD3DTextureButton);
}
