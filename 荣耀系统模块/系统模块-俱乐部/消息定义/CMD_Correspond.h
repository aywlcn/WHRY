...
//群服务
#define MDM_CS_GROUP_SERVICE				7								//群服务

#define SUB_CS_C_CREATE_GROUP				151								//创建群请求
#define SUB_CS_S_CREATE_GROUP_RESULT		152								//创建群应答
#define SUB_CS_C_HANDLE_ATTACH_GROUP		153								//处理加入群的请求
#define SUB_CS_S_HANDLE_ATTACH_GROUP_RESULT	154								//处理加入群请求的结果
#define SUB_CS_C_GROUP_LIST					155								//获取创建的群列表
#define SUB_CS_S_GROUP_LIST_RESULT			156								//获取创建的群列表结果
#define SUB_CS_C_GROUP_MEMBER               157                             //获取群成员
#define SUB_CS_S_GROUP_MEMBER_RESULT        158                             //获取群成员结果
#define SUB_CS_C_DELETE_GROUP_MEMBER        159                             //删除群成员
#define SUB_CS_S_DELETE_GROUP_MEMBER_RESULT 160                             //删除群成员结果
#define SUB_CS_C_MODIFY_GROUP_NAME          161                             //修改群名称
#define SUB_CS_S_MODIFY_GROUP_NAME_RESULT   162                             //修改群名称结果
#define SUB_CS_C_DISSOLVED_GROUP            163                             //解散群
#define SUB_CS_S_DISSOLVED_GROUP_RESULT     164                             //解散群结果
#define SUB_CS_C_GROUP_ROOM_LIST            165                             //群房间列表
#define SUB_CS_S_GROUP_ROOM_LIST_RESULT     166                             //群房间列表结果
#define SUB_CS_C_APPLY_ATTACH_GROUP         167                             //申请加入群
#define SUB_CS_S_APPLY_ATTACH_GROUP_RESULT  168                             //申请加入群结果
#define SUB_CS_C_GET_APPLY_GROUP_LIST       169                             //获取申请的群列表
#define SUB_CS_S_GET_APPLY_GROUP_LIST_RESULT 170                            //获取申请的群列表结果
