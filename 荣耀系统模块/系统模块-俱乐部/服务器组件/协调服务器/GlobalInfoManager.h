...
typedef CMap<CString, LPCTSTR, tagGroupInfo*, tagGroupInfo* &> CMapGroupInfo;
...
protected:
	...
	//-------------群信息
	CMapGroupInfo			m_MapGroupInfo;				//群信息
...
public:
	//生成群ID
	VOID RandGroupID(LPTSTR pszGroupID, WORD wMaxCount);
	//添加群
	bool AddServerGroup(CString strGroupID, tagGroupInfo groupInfo);
