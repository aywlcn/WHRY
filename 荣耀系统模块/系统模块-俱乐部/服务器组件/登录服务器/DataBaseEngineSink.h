...
protected:
	...
	//处理入群请求
	bool OnRequestHandleAttachGroup(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//获取群列表
	bool OnRequestQueryGroupTable(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//获取群成员列表
	bool OnRequestQueryGroupMember(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//删除群成员
	bool OnRequestDeleteGroupMember(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//修改群名称
	bool OnRequestModifyGroupName(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//解散群
	bool OnRequestDissolvedGroup(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//获取群房间列表
	bool OnRequestQueryGroupRoom(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//申请入群
	bool OnRequestApplyAttachGroup(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//获取申请入群的列表
	bool OnRequestQueryApplyGroup(DWORD dwContextID, VOID * pData, WORD wDataSize);
