...
protected:
	...
	//群服务
	bool OnTCPNetworkMainGroupService(WORD wSubCmdID, VOID * pData, WORD wDataSize);
	//网络事件
protected:
	//登录处理
...
protected:
	...
	//群处理
	bool OnTCPNetworkMainMBGroupTable(WORD wSubCmdID, VOID * pData, WORD wDataSize, DWORD dwSocketID);
...
protected:
	//创建群
	bool OnTCPNetworkSubCreateGroup(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//处理加入群的请求 
	bool OnTCPNetworkSubHandleAttachGroup(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//获取群列表
	bool OnTCPNetworkSubGetGroupList(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//获取群成员列表
	bool OnTCPNetworkSubGetGroupMemberList(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//删除群成员
	bool OnTCPNetworkSubDelGroupMember(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//修改群名称
	bool OnTCPNetworkSubModifyGroupName(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//解散群
	bool OnTCPNetworkSubDissolvedGroup(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//获取群房间列表
	bool OnTCPNetworkSubGetGroupRoomList(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//申请加入群
	bool OnTCPNetworkSubApplyAttachGroup(VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//获取申请入群的消息列表
	bool OnTCPNetworkSubGetApplyGroupList(VOID * pData, WORD wDataSize, DWORD dwSocketID);
...
protected:
	...
	//-----群
	//创建成功
	bool OnDBCreateGroupSucess(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//创建失败
	bool OnDBCreateGroupFailure(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//申请入群处理结果
	bool OnDBHandleAttachGroupResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//获取群列表
	bool OnDBGetGroupListResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//获取群成员列表
	bool OnDBGetGroupMemberListResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//删除群成员
	bool OnDBDeleteGroupMemberResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//修改群名称
	bool OnDBModifyGroupNameResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//解散群
	bool OnDBDissolvedGroupResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//获取群房间列表
	bool OnDBGetGroupRoomListResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//申请入群
	bool OnDBApplyAttachGroupResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//获取申请的群列表
	bool OnDBGetApplyGroupListResult(DWORD dwContextID, VOID * pData, WORD wDataSize);
