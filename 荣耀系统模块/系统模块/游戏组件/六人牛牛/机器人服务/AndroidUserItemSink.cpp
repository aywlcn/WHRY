...
//游戏时间
#define TIME_USER_CALL_BANKER			5									//叫庄时间
		...
		case IDI_CALL_BANKER:		//叫庄定时
			{
				...
				CallBanker.cbBankerTimes = rand()%5;
				if (CallBanker.cbBankerTimes == 0)
...
bool CAndroidUserItemSink::OnEventGameMessage(WORD wSubCmdID, void * pData, WORD wDataSize)
{
	...
	case SUB_S_CALL_BANKERINFO:
		{	
			//开牌时间
			CMD_S_CallBankerInfo *pCallBankerInfo = (CMD_S_CallBankerInfo *)pData;
			m_wBankerUser = pCallBankerInfo->wBankerUser;
...
// 				WORD chairID = m_pIAndroidUserItem->GetChairID();
// 				DWORD userID = m_pIAndroidUserItem->GetUserID();
...
bool CAndroidUserItemSink::OnSubSendCard(const void * pBuffer, WORD wDataSize)
{
	...
	m_wBankerUser = pSendCard->wBankerUser;
