...
bool CDlgCustomRule::SaveCustomRule(LPBYTE pcbCustomRule, WORD wCustomSize)
{
	...
	if (m_DlgCustomGeneral.m_CustomGeneral.lDartTime<5 || m_DlgCustomGeneral.m_CustomGeneral.lDartTime>99)
	{
		AfxMessageBox(L"[飞镖时间]输入范围为5-99");
		return false;
	}
	...
	if (m_DlgCustomGeneral.m_CustomGeneral.lEndTime<5||m_DlgCustomGeneral.m_CustomGeneral.lEndTime>99)
	{
		AfxMessageBox(L"[结束时间]输入范围为5-99");
	 return false;
	}
	...
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iBig)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iSmall)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iMiddle)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iMiddle1)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iFu)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iFu1)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iLu)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iLu1)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iShou)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iShou1)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iPair)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iPair1)) return false;
	if (!CheckOddsDataMinMax(m_DlgCustomGeneral.m_CustomGeneral.tOdds.iPair2)) return false;
...
VOID CDlgCustomGeneral::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_GENERAL_21, m_CustomGeneral.lDartTime);
	...
	DDX_Text(pDX, IDC_EDIT_BIG, m_CustomGeneral.tOdds.iBig);
	DDX_Text(pDX, IDC_EDIT_SMALL, m_CustomGeneral.tOdds.iSmall);
	DDX_Text(pDX, IDC_EDIT_MID, m_CustomGeneral.tOdds.iMiddle);
	DDX_Text(pDX, IDC_EDIT_MID1, m_CustomGeneral.tOdds.iMiddle1);
	//DDX_Text(pDX, IDC_EDIT_FU, m_CustomGeneral.tOdds.iFu);
	DDX_Text(pDX, IDC_EDIT_FU1, m_CustomGeneral.tOdds.iFu1);
	//DDX_Text(pDX, IDC_EDIT_LU, m_CustomGeneral.tOdds.iLu);
	DDX_Text(pDX, IDC_EDIT_LU1, m_CustomGeneral.tOdds.iLu1);
	//DDX_Text(pDX, IDC_EDIT_SHOU, m_CustomGeneral.tOdds.iShou);
	DDX_Text(pDX, IDC_EDIT_SHOU1, m_CustomGeneral.tOdds.iShou1);
	//DDX_Text(pDX, IDC_EDIT_PAIR, m_CustomGeneral.tOdds.iPair);
	DDX_Text(pDX, IDC_EDIT_PAIR1, m_CustomGeneral.tOdds.iPair1);
	DDX_Text(pDX, IDC_EDIT_PAIR2, m_CustomGeneral.tOdds.iPair2);
...
bool CDlgCustomRule::CheckOddsDataMinMax(int valueMax)
{
	if (valueMax<1 || valueMax>1000)
	{

		CString str;
		str.Format(L"输入范围为1-%d", 1000);
		AfxMessageBox(str);
