...
//游戏属性
#define KIND_ID						55									//游戏 I D
#define GAME_NAME					TEXT("飞镖游戏")					//游戏名字
...
#define GAME_SCENE_DART				GAME_STATUS_PLAY+1					//射飞镖状态
#define GAME_SCENE_GAME_END			GAME_STATUS_PLAY+2					//结束状态
...
#define ID_PAIR					18									//豹子
#define ID_PAIR1				19									//对1
#define ID_PAIR6				20									//对6
#define ID_PAIR2				21									//对2
#define ID_PAIR3				22									//对3
#define ID_PAIR4				23									//对4
#define ID_PAIR5				24									//对5
...
#define SUB_S_DART					102									//发射飞镖
#define SUB_S_GAME_END				103									//游戏结束


#define SUB_S_APPLY_BANKER			113									//申请庄家
...
#define SUB_S_PLAYER_LIST			114									//玩家列表
#define SUB_S_BANKER_LIST			115									//上台列表
#define SUB_S_RECORD_LIST			116									//k线数据

#define SUB_S_SEATINFO				117									//座位信息
#define SUB_S_StartDart				118									//开始发射飞镖
...
struct CMD_S_StatusFree
{
	...
	tagOdds							tOdds;								//赔率
	WORD							tSeatInfo[SEAT_COUNT];				//椅子号对应的玩家信息
};
...
struct CMD_S_StatusPlay
{
	...
	tagOdds							tOdds;								//赔率
	WORD							tSeatInfo[SEAT_COUNT];				//座位号对应的椅子号
	BYTE							cbPoint[2];							//飞镖点数
	bool							bIsBanker;							//是否已上台
};
...
struct CMD_S_GameStart
{
	...
	LONGLONG						nChipRobotCount;					//人数上限 (下注机器人)
	LONGLONG						nAndriodApplyCount;					//机器人列表人数
	tagOdds							tOdds;								//赔率
};
...
{
	LONGLONG						cbTimeLeave;						//剩余时间
	WORD							wFirstDartUser;						//第一个射飞镖玩家
	WORD							wSecDartUser;						//第二个射飞镖玩家	
	BYTE							cbPoint[2];
};
...
#define SUB_C_DART					2									//发射飞镖
#define SUB_C_AMDIN_COMMAND			3									//管理员命令
#define SUB_C_UPDATE_STORAGE        4									//更新库存

#define SUB_C_APPLY_BANKER			5									//申请上台
#define SUB_C_CANCEL_BANKER			6									//取消上台
#define SUB_C_ALLPLAYER_LIST		7									//玩家列表
#define	SUB_C_ALLBANKER_LIST		8									//上台列表
#define SUB_C_ALLRECORD_LIST		9									//游戏记录列表

#define SUB_C_SITDOWN				10									//入座消息
#define SUB_C_LEAVESEAT				11									//离开座位
