...
protected:
    ...
    BYTE							m_cbTableCardArray[4][3];				//桌面扑克
...
protected:
	...
	// 判断输赢
	void JudgeSystemScore( BYTE bCardData[4][3], LONGLONG& lSystemScore, bool& bAllEat );
	// 记录函数
...
private:
	...
	void DeduceWinnerEx(int *compareResult);
	void ControlWinArea();
};
