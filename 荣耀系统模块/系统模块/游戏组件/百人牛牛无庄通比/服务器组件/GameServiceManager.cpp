...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME	TEXT("OxBattleTongBiAndroid.dll")	//组件名字
#else
#define ANDROID_SERVICE_DLL_NAME	TEXT("OxBattleTongBiAndroid.dll")	//组件名字
#endif
//构造函数
CGameServiceManager::CGameServiceManager()
{
	...
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("OxBattleTongBiServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
