...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME  TEXT("ZhaJinHuaSixAndroid.dll") //组件名字
#else
#define ANDROID_SERVICE_DLL_NAME  TEXT("ZhaJinHuaSixAndroid.dll") //组件名字
#endif
...
CGameServiceManager::CGameServiceManager()
{
  ...
  lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("ZhaJinHuaSix.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
  lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("ZhaJinHuaSixServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
bool CGameServiceManager::DefaultCustomRule(LPBYTE pcbCustomRule, WORD wCustonSize)
{
  ...
  pCustomRule->bCompareSmall = 0;
  pCustomRule->wMaxOpenTurn = 15;
  pCustomRule->wMinCompareTurn = 0;
  pCustomRule->wMinLookTurn = 0;

  pCustomRule->cbCompareWay = 0;
