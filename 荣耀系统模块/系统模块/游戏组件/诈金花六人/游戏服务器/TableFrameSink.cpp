...
CTableFrameSink::CTableFrameSink()
{
  ...
  m_hControlInst = LoadLibrary(TEXT("ZhaJinHuaSixServerControl.dll"));
  if(m_hControlInst)
  {
    typedef void * (*CREATE)();
...
bool  CTableFrameSink::OnEventSendGameScene(WORD wChairID, IServerUserItem * pIServerUserItem, BYTE cbGameStatus, bool bSendSecret)
{
  switch(cbGameStatus)
  {
    case GAME_STATUS_FREE:    //空闲状态
    {
	  ...
	  StatusFree.lMaxOpenScore = (m_lMaxOpenScore == 0xFFFFFFFF ? 0 : m_lMaxOpenScore);
    ...
    case GAME_STATUS_PLAY:  //游戏状态
    {
	  ...
	  StatusPlay.lMaxOpenScore = (m_lMaxOpenScore == 0xFFFFFFFF ? 0 : m_lMaxOpenScore);
