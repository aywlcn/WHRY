...
{
  CString strName;
  strName.Format(TEXT("%s\\ZhaJinHuaSix-%s.log"), GetFileDialogPath(), strRoomName);
...
public:
  ...
  //对比扑克
  BYTE CompareCard(BYTE cbFirstData[], BYTE cbNextData[], BYTE cbCardCount,BOOL bCompareSamll = FALSE);
};
