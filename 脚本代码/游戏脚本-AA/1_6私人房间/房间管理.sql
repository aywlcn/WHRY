...
BEGIN
	...
	-- 插入私人房间参数
	INSERT INTO PersonalRoomInfo (ServerID,  KindID, CardOrBean, PayOwnerOrAA, FeeBeanOrRoomCard, IsJoinGame, MinPeople, MaxPeople, PersonalRoomTax, MaxCellScore, CanCreateCount, 
	...
	VALUES (@wServerID,@wKindID,  @cbCardOrBean, @cbPayType, @lFeeBeanOrRoomCard, @cbIsJoinGame, @cbMinPeople, @cbMaxPeople, @lPersonalRoomTax, @lMaxCellScore, @wCanCreateCount, @wPlayTurnCount, 
...
BEGIN
	...
	BEGIN
		--插入私人房间参数
		UPDATE PersonalRoomInfo SET CardOrBean = @cbCardOrBean, PayOwnerOrAA = @cbPayType, FeeBeanOrRoomCard = @lFeeBeanOrRoomCard, IsJoinGame = @cbIsJoinGame, MinPeople = @cbMinPeople, MaxPeople = @cbMaxPeople,PersonalRoomTax = @lPersonalRoomTax, MaxCellScore = @lMaxCellScore,
