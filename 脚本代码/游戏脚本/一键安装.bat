...
echo *************************************************************************
echo                              荣耀版一键安装
echo     执行荣耀版数据库一键安装脚本，自动备份"E:\数据库\荣耀平台"目录下的数据库，
...
md E:\数据库\荣耀平台备份\%ymd%
XCOPY E:\数据库\荣耀平台\* E:\数据库\荣耀平台备份\%ymd% /s  /e
if exist E:\数据库\荣耀平台 (echo y|cacls E:\数据库\荣耀平台 /p everyone:f >nul 2>nul &&rd /s /q E:\数据库\荣耀平台) 
md E:\数据库\荣耀平台
