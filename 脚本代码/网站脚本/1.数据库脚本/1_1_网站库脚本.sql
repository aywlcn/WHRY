...
( NAME = N'RY_RYNativeWebDB', FILENAME = N'E:\数据库\荣耀平台\RYNativeWebDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'RY_RYNativeWebDB_log', FILENAME = N'E:\数据库\荣耀平台\RYNativeWebDB_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
