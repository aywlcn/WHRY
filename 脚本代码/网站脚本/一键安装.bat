...
TITLE 网狐经典版数据库自动安装中...请注意：安装过程中请勿关闭
...
set rootPath=3.存储过程\房卡脚本\
osql -E -i "%rootPath%房卡兑换-房卡后台.sql"
osql -E -i "%rootPath%房卡兑换-普通玩家.sql"
osql -E -i "%rootPath%房卡购买-房卡后台.sql"
osql -E -i "%rootPath%房卡购买-普通玩家.sql"
osql -E -i "%rootPath%房卡赠送-房卡后台.sql"
osql -E -i "%rootPath%在线房卡充值.sql"
osql -E -i "%rootPath%在线房卡订单.sql"
